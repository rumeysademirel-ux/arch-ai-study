    ...
    <div className={`rounded border border-border bg-white ${compact ? "p-4" : "p-6"}`}>
      ...
      <div className={`space-y-4 text-sm text-foreground ${compact ? "mt-3" : "mt-5"}`}>
        <section>
          ...
          <p className="mt-1 whitespace-pre-line leading-6">{task.problem}</p>
        </section>
        {task.targetUser && (
          <section>
        ...
        {task.keyNeeds && task.keyNeeds.length > 0 && (
          <section>
        ...
        <section>
          ...
          <p className="mt-1 whitespace-pre-line leading-6">{task.expectedOutput}</p>
        </section>
      </div>
    </div>
  );
